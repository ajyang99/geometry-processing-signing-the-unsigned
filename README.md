...
[Poisson Surface Reconstruction assignment](https://github.com/alecjacobson/geometry-processing-mesh-reconstruction), we first define a regular 3D grid of voxels containing at least the bounding box of <img src="svgs/384591906555413c452c93e493b2d4ec.svg?d4a374cd5b&invert_in_darkmode" align=middle width=12.922305000000005pt height=22.557149999999986pt/>. We then estimate the unsigned distance at each
sampled point in the grid, and only keep the point <img src="svgs/b0ea07dc5c00127344a1cad40467b8de.svg?7caffe258&invert_in_darkmode" align=middle width=9.977220000000004pt height=14.61206999999998pt/> with
<p align="center"><img src="svgs/523748779f10020f720f1aa01902bded.svg?22475dddaa&invert_in_darkmode" align=middle width=73.71803999999999pt height=16.438356pt/></p>
where <img src="svgs/2ad9d098b937e46f9f58968551adac57.svg?a39685c003&invert_in_darkmode" align=middle width=9.471165000000003pt height=22.831379999999992pt/> is the length of the voxel grid diagonal. The filtering step above aims to keep
...
tetrahedra mesh <img src="svgs/a27feed43ff187753bc9939ea2310530.svg?4a93b0b8e1&invert_in_darkmode" align=middle width=42.483045000000004pt height=24.65759999999998pt/>.

## <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?b0ea249a8a&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/>-Band Selection
Since <img src="svgs/2ad9d098b937e46f9f58968551adac57.svg?a386d7010d&invert_in_darkmode" align=middle width=9.471165000000003pt height=22.831379999999992pt/> is a loose threshold, the coarse mesh <img src="svgs/a27feed43ff187753bc9939ea2310530.svg?d904c7246d&invert_in_darkmode" align=middle width=42.483045000000004pt height=24.65759999999998pt/> constructed above does not best reflect
the shape of the surface. To represent the shape better, we find an <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?6db5f28891&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/>-band
which is made up of all points, edges, faces and tetrahedra in the coarse mesh that have an unsigned distance <img src="svgs/ce9b6c510f151c6e44972cf13ed1093f.svg?db5de311a3&invert_in_darkmode" align=middle width=24.024pt height=17.723969999999973pt/>. Our goal is thus to find the value of <img src="svgs/c88e6eec3577c600d80577992caabb22.svg?abebad02ce&invert_in_darkmode" align=middle width=68.197965pt height=22.831379999999992pt/>
that best captures the surface boundary.

The gif below illustrates the <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?d81dfc7c12&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/>-band with different <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?dbab3e2649&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/> values.

![](images/sec2_vis/eps_band_vis.gif)

To select the <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?828379310d&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/> value automatically, the paper uses a function
<p align="center"><img src="svgs/d99e19acc357bc1ad5ef863ff083de67.svg?642aaef81c&invert_in_darkmode" align=middle width=200.49314999999999pt height=38.834894999999996pt/></p>
where <img src="svgs/9b325b9e31e85137d1de765f43c0f8bc.svg?485d32f132&invert_in_darkmode" align=middle width=12.924780000000005pt height=22.46574pt/>, <img src="svgs/7b9a0316a2fcd7f01cfd556eedf72e96.svg?143696460a&invert_in_darkmode" align=middle width=14.999985000000004pt height=22.46574pt/>, <img src="svgs/5201385589993766eea584cd3aa6fa13.svg?791a67b2a7&invert_in_darkmode" align=middle width=12.924780000000005pt height=22.46574pt/> are the number of components, cavities and tunnels in the <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?94f2b94e11&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/>-band.
<img src="svgs/78ec2b7008296ce0561cf83393cb746d.svg?6b7d41e7da&invert_in_darkmode" align=middle width=14.066250000000002pt height=22.46574pt/> is the density of input points in the band. The detailed steps are:

First, we sample 200 possible <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?24122cf260&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/> values by sorting all vertices <img src="svgs/a9a3a4a202d80326bda413b5562d5cd1.svg?6d3d30df4f&invert_in_darkmode" align=middle width=13.242075000000003pt height=22.46574pt/> based on the respective
unsigned distance, and splitting the vertices into 200 equal-sized buckets. The max unsigned
distance in each bucket will correspond to a potential <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?9313820baa&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/> value.

Next, we bucket all input points <img src="svgs/384591906555413c452c93e493b2d4ec.svg?746729f19b&invert_in_darkmode" align=middle width=12.922305000000005pt height=22.557149999999986pt/> and tetrahedra <img src="svgs/2f118ee06d05f3c2d98361d9c30e38ce.svg?42f58e72a8&invert_in_darkmode" align=middle width=11.889405000000002pt height=22.46574pt/> in the coarse mesh into the 200
intervals based on the respective unsigned distance. We then compute the number of components of each <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?82ddf0e52b&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/>-band with union-find as we insert tetrahedra with increasing <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?43f6f589f5&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/> thresholds. The number of cavities can be found similarily in the reverse order.
We then calculate
<img src="svgs/a75cc39d6a8fed15e3d956372092c18c.svg?a5f4138edf&invert_in_darkmode" align=middle width=191.06620499999997pt height=24.65759999999998pt/> where <img src="svgs/5212d968722a044959929d10373da783.svg?8e751a1219&invert_in_darkmode" align=middle width=199.53235499999997pt height=24.65759999999998pt/> is
...
We then plot the function of <img src="svgs/577c43dbad72bced5ed631b967c67157.svg?36b8792c6&invert_in_darkmode" align=middle width=37.1976pt height=24.65759999999998pt/>. The paper suggests smoothing the output slightly
and chooses the first local minimum after first local maximum based on empirical results.
In our experiments, we observed similar shapes of the <img src="svgs/fb97d38bcc19230b0acd442e17db879c.svg?74fe4839d&invert_in_darkmode" align=middle width=17.739810000000002pt height=22.46574pt/> plots as the paper, but found that
choosing <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?3831fadaff&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/> as the median of unsigned distance at all vertices gives the best result
with the full algorithm.

The image below shows the <img src="svgs/577c43dbad72bced5ed631b967c67157.svg?6ddc8cbecd&invert_in_darkmode" align=middle width=37.1976pt height=24.65759999999998pt/> function with respect to the bucket index for all three test point clouds.
Nearest-neighbor hyperparameter <img src="svgs/d6328eaebbcd5c358f426dbea4bdbf70.svg?d949605319&invert_in_darkmode" align=middle width=15.137100000000004pt height=22.46574pt/>=5 here.
...
mesh from Delaunay triangulation, and the <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?174de1466&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/>-band chosen based on the
auto-selected <img src="svgs/577c43dbad72bced5ed631b967c67157.svg?128ef8202&invert_in_darkmode" align=middle width=37.1976pt height=24.65759999999998pt/> values.

![](images/sec2_vis/meshes.png)

## <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?775fa14dde&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/>-Band Refinement
Input points in the chosen <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?5ebb03474b&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/>-band are most likely to be close to the surface and
not noisy. Therefore, we can refine the unsigned distances of vertices within the band using
only input points inside the band. Instead of directly using the <img src="svgs/d6328eaebbcd5c358f426dbea4bdbf70.svg?a3bbbd1b4a&invert_in_darkmode" align=middle width=15.137100000000004pt height=22.46574pt/> nearest neighbors
inside the band, we now stochastically fit a plane with the neighbors. Specifically,
we take <img src="svgs/0e51a2dede42189d77627c4d742822c3.svg?32b44c0498&invert_in_darkmode" align=middle width=14.433210000000003pt height=14.155350000000013pt/> random subsets of size <img src="svgs/8217ed3c32a785f0b5aad4055f432ad8.svg?9a020fdc78&invert_in_darkmode" align=middle width=10.165650000000005pt height=22.831379999999992pt/>. For each subset, we fit a plane with PCA and
...
the hyperparameters associated with discretization density, the nearest neighbor <img src="svgs/d6328eaebbcd5c358f426dbea4bdbf70.svg?3b8a13b209&invert_in_darkmode" align=middle width=15.137100000000004pt height=22.46574pt/>,
the number of rays used for sign esitmation, and the
smoothness hyperparametere <img src="svgs/c745b9b57c145ec5577b82542b2df546.svg?2cf591e80b&invert_in_darkmode" align=middle width=10.576500000000003pt height=14.155350000000013pt/>.
In addition, the automatic <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?8a4fc5fb02&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/>-band selection heuristics might not give overall best
result even though the band visualization with the chosen <img src="svgs/7ccca27b5ccc533a2dd72dc6fa28ed84.svg?e634ab4c7b&invert_in_darkmode" align=middle width=6.672451500000003pt height=14.155350000000013pt/> looks reasonable.
